...
export function ResumeForm({ onAnalyze, onFileChange, file, isLoading }: ResumeFormProps) {
  ...
  const isReady = file && jobDescription.trim()
    ...
    <div className="space-y-8">
      <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            <div className="flex h-7 w-7 items-center justify-center rounded-full bg-primary text-xs font-bold text-primary-foreground shadow-md shadow-primary/40">
              1
            </div>
            <div>
          ...
          {!file ? (
            <div
              {...getRootProps()}
              className={`group cursor-pointer rounded-xl border-2 border-dashed p-10 transition-all duration-300 min-h-[240px] flex items-center justify-center ${
                isDragActive
            ...
            >
              ...
              <div className="flex flex-col items-center text-center">
                <div className={`mb-5 rounded-2xl p-5 transition-all duration-300 ${
            ...
            <div className="min-h-[240px] flex items-start">
              <Card className="border border-primary/40 bg-primary/5 w-full">
      ...
      <div className="mx-auto max-w-md">
        <Button
          ...
          className="group w-full rounded-2xl py-7 text-base font-semibold transition-all duration-300 disabled:opacity-40 cursor-pointer hover:bg-primary/80 glow-primary-20 disabled:shadow-none"
          size="lg"
        >
          {isLoading ? (
